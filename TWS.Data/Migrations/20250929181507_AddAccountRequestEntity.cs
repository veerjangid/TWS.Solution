...
{
    /// <inheritdoc />
    public partial class AddAccountRequestEntity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Message = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RequestDate = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccountRequests_AspNetUsers_ProcessedByUserId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "554f2547-db52-4f2b-a54d-1479efebe0e4", "Investor", "INVESTOR" },
                    { "2", "b33c25c8-19fc-4ba7-8a7d-9d61b50c554f", "Advisor", "ADVISOR" },
                    { "3", "3cec5a99-67ae-47b2-b2ba-fc18c10ca9be", "OperationsTeam", "OPERATIONSTEAM" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountRequests_IsProcessed",
                table: "AccountRequests",
                column: "IsProcessed");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountRequests_RequestDate",
                table: "AccountRequests",
                column: "RequestDate");
